...
<span class="column-img" alt style="width: 100%">${n.c2_content }</span>
...
<span class="noto-sb mb-1">${recnt }</span>
</div>
...
<c:otherwise>
    ...
    <c:otherwise>
      <a class="page-link" href="page.change2?p=${curPage + 1 }" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </c:otherwise>
    </c:choose>
