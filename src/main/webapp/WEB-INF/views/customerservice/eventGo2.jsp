	...
	<div class="main container mt-5">
		<div class="btn-group" role="group"
			...
			<input type="radio" class="btn-check" name="btnradio" id="btnradio1"
				...
				autocomplete="off" checked> <label class="btn btn-outline-primary"
...
<c:otherwise>
      ...
      <a class="page-link" href="event.page.change2?p=${curPage - 1 }" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    ...
    <c:forEach var="p" begin="1" end="${pageCount }">
    	<li class="page-item"><a class="page-link" href="event.page.change2?p=${p }">${p}</a></li>
 	</c:forEach>
    ...
    <c:otherwise>
      <a class="page-link" href="event.page.change2?p=${curPage + 1 }" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </c:otherwise>
    </c:choose>
