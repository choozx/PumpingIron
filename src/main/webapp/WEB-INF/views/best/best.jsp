...
<span class="noto-sb text-gray"><fmt:formatDate value="${b.b_date }" type="date" dateStyle="short"/></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<div class="d-flex align-items-center">
<img  src="resources/img/tips/heart-fill.svg" class="mr-1 column-like" style="max-width: 20px">
<span class="noto-sb mb-1">${b.b_like }</span>


</div>
<div class="d-flex align-items-center ml-2">
<img alt="" src="resources/img/tips/cnt.png" class="mr-1 column-like">
<span class="noto-sb mb-1">${b.b_bodyProfile }</span>
</div>

</div>
<div class="column-title noto-h4 column-mb-15 text-break text-overflow-3">${b.b_title }</div>
...
<span style="font-size: 12px; font-weight: bold;" >${b.b_views }</span>
</div>
</div> 
</a>
    </div>
...
<c:otherwise>
      ...
      <a class="page-link" href="page4.change?p=${curPage - 1 }" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    ...
    <c:forEach var="p" begin="1" end="${pageCount }">
    	<li class="page-item"><a class="page-link" href="page4.change?p=${p }">${p }</a></li>
 	</c:forEach>
    ...
    <c:otherwise>
      <a class="page-link" href="page4.change?p=${curPage + 1 }" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </c:otherwise>
    </c:choose>
