...
<form action="customerservice.associate.do" method="post">
			...
			<div class="col-sm-12 col-lg-6">
				<div class="card flex-center">
					<div class="card-body">
						...
						<input style="width: 400px;"  class="mt-1" name="m_email">
						...
						<textarea style="width: 400px; height: 65px;" class="mt-1" name="m_photo"></textarea>
						</div>
